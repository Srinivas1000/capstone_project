      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/AccessTokens/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Reviewer.accessTokens.findById() instead.
            "::findById::Reviewer::accessTokens": {
              params: {
                'fk': '@fk',
              },
            ...
            // INTERNAL. Use Reviewer.accessTokens.destroyById() instead.
            "::destroyById::Reviewer::accessTokens": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Reviewers/:id/accessTokens/:fk",
            ...
            // INTERNAL. Use Reviewer.accessTokens.updateById() instead.
            "::updateById::Reviewer::accessTokens": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Reviewers/:id/accessTokens/:fk",
            ...
            // INTERNAL. Use Reviewer.accessTokens() instead.
            "::get::Reviewer::accessTokens": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/accessTokens",
              method: "GET",
            },

            // INTERNAL. Use Reviewer.accessTokens.create() instead.
            "::create::Reviewer::accessTokens": {
              url: urlBase + "/Reviewers/:id/accessTokens",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.accessTokens.createMany() instead.
            "::createMany::Reviewer::accessTokens": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/accessTokens",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.accessTokens.destroyAll() instead.
            "::delete::Reviewer::accessTokens": {
              url: urlBase + "/Reviewers/:id/accessTokens",
              method: "DELETE",
            },

            // INTERNAL. Use Reviewer.accessTokens.count() instead.
            "::count::Reviewer::accessTokens": {
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Reviewers/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Reviewer.events.findById() instead.
            "prototype$__findById__events": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Reviewers/:id/events/:fk",
              method: "GET",
            },

            // INTERNAL. Use Reviewer.events.destroyById() instead.
            ...
            // INTERNAL. Use Reviewer.events.updateById() instead.
            ...
            // INTERNAL. Use Reviewer.events() instead.
            "prototype$__get__events": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/events",
              method: "GET",
            },

            // INTERNAL. Use Reviewer.events.create() instead.
            "prototype$__create__events": {
              url: urlBase + "/Reviewers/:id/events",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.events.destroyAll() instead.
            "prototype$__delete__events": {
              url: urlBase + "/Reviewers/:id/events",
              method: "DELETE",
            },

            // INTERNAL. Use Reviewer.events.count() instead.
            "prototype$__count__events": {
              url: urlBase + "/Reviewers/:id/events/count",
              method: "GET",
            },
            ...
            // INTERNAL. Use Event.reviewer() instead.
            "::get::Event::reviewer": {
              url: urlBase + "/Events/:id/reviewer",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.Reviewer.accessTokens
     * @header lbServices.Reviewer.accessTokens
     * @object
     * @description
     *
     * The object `Reviewer.accessTokens` groups methods
     * manipulating `AccessToken` instances related to `Reviewer`.
     *
     * Call {@link lbServices.Reviewer#accessTokens Reviewer.accessTokens()}
     * to query all related instances.
     */
        ...
        R.accessTokens = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::get::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#count
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.count = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::count::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#create
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.create = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::create::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#createMany
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.createMany = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::createMany::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#destroyAll
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.destroyAll = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::delete::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#destroyById
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.destroyById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::destroyById::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#findById
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.findById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::findById::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.accessTokens#updateById
             * @methodOf lbServices.Reviewer.accessTokens
             *
             * @description
             *
        ...
        R.accessTokens.updateById = function() {
          var TargetResource = $injector.get("AccessToken");
          var action = TargetResource["::updateById::Reviewer::accessTokens"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Reviewer.events
     * @header lbServices.Reviewer.events
     * @object
     * @description
     *
     * The object `Reviewer.events` groups methods
     * manipulating `Event` instances related to `Reviewer`.
     *
     * Call {@link lbServices.Reviewer#events Reviewer.events()}
     * to query all related instances.
     */
        ...
        R.events = function() {
          ...
          var action = TargetResource["::get::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#count
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
             * Counts events of Reviewer.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - User id
        ...
        R.events.count = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::count::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#create
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.create = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::create::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#createMany
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.createMany = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::createMany::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#destroyAll
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.destroyAll = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::delete::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#destroyById
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.destroyById = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::destroyById::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#findById
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.findById = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::findById::Reviewer::events"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Reviewer.events#updateById
             * @methodOf lbServices.Reviewer.events
             *
             * @description
             *
        ...
        R.events.updateById = function() {
          var TargetResource = $injector.get("Event");
          var action = TargetResource["::updateById::Reviewer::events"];
          return action.apply(R, arguments);
        };
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Events/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Reviewer.events.create() instead.
            "::create::Reviewer::events": {
              url: urlBase + "/Reviewers/:id/events",
              method: "POST",
            },

            // INTERNAL. Use Reviewer.events.createMany() instead.
            "::createMany::Reviewer::events": {
              isArray: true,
              url: urlBase + "/Reviewers/:id/events",
              method: "POST",
            },
            ...
            // INTERNAL. Use Reviewer.events.destroyAll() instead.
            "::delete::Reviewer::events": {
              url: urlBase + "/Reviewers/:id/events",
              method: "DELETE",
            },

            // INTERNAL. Use Reviewer.events.count() instead.
            "::count::Reviewer::events": {
              url: urlBase + "/Reviewers/:id/events/count",
              method: "GET",
            },
          }
        ...
        */
        R.modelName = "Event";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Event#reviewer
             * @methodOf lbServices.Event
             *
             * @description
             *
        ...
        R.reviewer = function() {
          ...
          var action = TargetResource["::get::Event::reviewer"];
          return action.apply(R, arguments);
        };
